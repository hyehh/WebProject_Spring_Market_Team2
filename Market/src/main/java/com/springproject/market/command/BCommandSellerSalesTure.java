...
public class BCommandSellerSalesTure implements BCommand {
	...
	public void execute(HttpSession session, Model model, SqlSession sqlSession) {
		...
		int total = dao.salesTrue(); //총 게시물 수
...
//						((1-1) / 10 * 10) + 1
		...
		dtos1 = dao.salesTureList(BControllerSeller.from, BControllerSeller.to);
