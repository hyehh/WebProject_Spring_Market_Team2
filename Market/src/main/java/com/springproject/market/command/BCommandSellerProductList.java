...
public class BCommandSellerProductList implements BCommand {
	...
	public void execute(HttpSession session, Model model, SqlSession sqlSession) {
		...
		ArrayList<BDtoSellerProduct> dtos = null;
...
//						((1-1) / 10 * 10) + 1
		...
		dtos = dao.list(BControllerSeller.from, BControllerSeller.to); // 리스트를 구하기 위한메소드
