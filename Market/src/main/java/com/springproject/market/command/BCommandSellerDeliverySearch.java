...
public class BCommandSellerDeliverySearch implements BCommand {
	...
	public void execute(HttpSession session, Model model, SqlSession sqlSession) {
		...
		int total = dao.searchDeliveryCount(search, searchtxt, BControllerSeller.from, BControllerSeller.to); //총 게시물 수
...
//						((1-1) / 10 * 10) + 1
		...
		ArrayList<BDtoSellerDelivery> dtos = dao.search(search, searchtxt, BControllerSeller.from, BControllerSeller.to);
