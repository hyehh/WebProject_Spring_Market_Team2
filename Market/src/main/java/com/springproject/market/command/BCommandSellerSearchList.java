...
public class BCommandSellerSearchList implements BCommand {
...
//								((1-1) / 10 * 10) + 1
		...
		ArrayList<BDtoSellerProduct> dtos2 = dao.search(search, searchtxt, BControllerSeller.from,
				BControllerSeller.to);
