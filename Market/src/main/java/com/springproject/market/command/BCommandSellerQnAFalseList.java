...
public class BCommandSellerQnAFalseList implements BCommand {
	...
	public void execute(HttpSession session, Model model, SqlSession sqlSession) {
		...
		int total = dao.QnAFalse(); // 총 게시물 수
...
//						((1-1) / 10 * 10) + 1
		...
		dtos = dao.QnAFalseList(BControllerSeller.from, BControllerSeller.to);
		// 계속가져갈것
