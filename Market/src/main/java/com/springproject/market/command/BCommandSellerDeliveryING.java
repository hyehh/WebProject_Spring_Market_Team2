...
public class BCommandSellerDeliveryING implements BCommand {
	...
	public void execute(HttpSession session, Model model, SqlSession sqlSession) {
		...
		int total = dao.deliveryING(); //총 게시물 수
...
//						((1-1) / 10 * 10) + 1
		...
		dtos = dao.deliveryINGList(BControllerSeller.from, BControllerSeller.to);
