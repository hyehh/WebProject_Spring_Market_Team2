...
public class BCommandSellerDeliveryEnd implements BCommand {
	...
	public void execute(HttpSession session, Model model, SqlSession sqlSession) {
		...
		ArrayList<BDtoSellerDelivery> dtos = null;
		...
		int total = dao.deliveryEnd(); //총 게시물 수
...
//						((1-1) / 10 * 10) + 1
		...
		dtos = dao.deliveryEndList(BControllerSeller.from, BControllerSeller.to);
