...
public class BCommandSellerBuyCancelList implements BCommand {
	...
	public void execute(HttpSession session, Model model, SqlSession sqlSession) {
		...
		ArrayList<BDtoSellerBuy> dtos = null;
		...
		int total = dao.buyCancel(); // 총 게시물 수
...
//						((1-1) / 10 * 10) + 1
		...
		dtos = dao.buyCancelList(BControllerSeller.from, BControllerSeller.to);
