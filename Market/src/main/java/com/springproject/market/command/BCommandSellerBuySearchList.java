...
public class BCommandSellerBuySearchList implements BCommand {
	...
	public void execute(HttpSession session, Model model, SqlSession sqlSession) {
		...
		int total = dao.searchBuyCount(search, searchtxt); // 총 게시물 수
...
//						((1-1) / 10 * 10) + 1
		...
		ArrayList<BDtoSellerBuy> dtos = dao.search(search, searchtxt, BControllerSeller.from, BControllerSeller.to);
