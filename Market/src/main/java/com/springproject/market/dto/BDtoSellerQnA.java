...
public class BDtoSellerQnA {
	...
	public BDtoSellerQnA() {
		// TODO Auto-generated constructor stub
	}

	public BDtoSellerQnA(String qnACode, String customer_cId, String qTitle, String qContent, String qAddDate, String aAddDate,
	...
	public BDtoSellerQnA(String cId, String sId, String bCondition, String qContent, String qAddDate, String bNumber) {
		super();
		this.cId = cId;
		this.sId = sId;
	...
	public BDtoSellerQnA(int qnaCode, String qAddDate, String bNumber, String qTitle, String qAnswerStatus) {
		super();
		this.qnaCode = qnaCode;
		this.qAddDate = qAddDate;
		this.bNumber = bNumber;
	...
	public BDtoSellerQnA(String qAddDate, String qTitle, String qAnswerStatus) {
		super();
		this.qAddDate = qAddDate;
		this.qTitle = qTitle;
		this.qAnswerStatus = qAnswerStatus;
	...
	public BDtoSellerQnA(String qContent, String qAddDate, String bNumber, String qTitle, String cName, String aContent,
			String pName) {
		super();
		this.qContent = qContent;
		this.qAddDate = qAddDate;
	...
	public BDtoSellerQnA(String qnACode, String qContent, String qAddDate, String bNumber, String qTitle, String qAnswerStatus,
	...
	public BDtoSellerQnA(String qnACode, String qTitle, String qAddDate, String qAnswerStatus) {
		super();
		this.qTitle = qTitle;
		this.qAddDate = qAddDate;
		this.qnACode = qnACode;
