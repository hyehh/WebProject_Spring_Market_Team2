...
public class BDtoSellerInsert {
	...
	public BDtoSellerInsert() {
		// TODO Auto-generated constructor stub
	}
	
	
	public BDtoSellerInsert(String pCategory, String pName, String pPrice, Timestamp pExpirationDate, String pProductEA,
			String pStatus) {
		super();
	...
	public BDtoSellerInsert(int pCode, String pCategory, String pName, String pPrice, Timestamp pExpirationDate, String pProductEA) {
		super();
		this.pCode = pCode;
		this.pCategory = pCategory;
		this.pName = pName;
	...
	public BDtoSellerInsert(int pCode, String sId, String rInsertDate) {
		super();
		this.pCode = pCode;
		this.sId = sId;
	...
	public BDtoSellerInsert(String sId, String rInsertDate) {
		super();
		this.sId = sId;
		this.rInsertDate = rInsertDate;
	}
