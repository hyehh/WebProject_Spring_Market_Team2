	...
	<div class="container_wrap">
		<div class="container">
			...
			<table class="table">
				<tr>
					<td align="center">
						<a href="buyList.do"><button type="button" class="buttonNum buttonNum">◀◀</button></a>
				        <a href="buyList.do?pg=${FROMPAGE }"><button type="button" class="buttonNum buttonNum">◀</button></a>
				        <c:forEach items = "${pageCount }" var = "page" varStatus="ftp">
				        <a href="buyList.do?pg=${ftp.count}"><button type="button" class="buttonNum buttonNum">${ftp.count }</button></a>
				        </c:forEach>
				        <a href="buyList.do?pg=${TOPAGE }"><button type="button" class="buttonNum buttonNum">▶</button></a>
				        <a href="buyList.do?pg=${ALLPAGE }"><button type="button" class="buttonNum buttonNum">▶▶</button></a>
					</td>
				</tr>
			</table>
		</div>
