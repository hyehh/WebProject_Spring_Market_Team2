	...
	<div class="container_wrap">
		<div class="container">
			...
			<table class="table">
				<tr>
					<td align="center">
				        <a href="QnAFalseList"><button type="button" class="buttonNum buttonNum">◀◀</button></a>
				        <a href="QnAFalseList?pg=${FROMPAGE }"><button type="button" class="buttonNum buttonNum">◀</button></a>
			        	<c:forEach items = "${pageCount }" var = "page" varStatus="ftp">
		        		<a href="QnAFalseList?pg=${ftp.count}"><button type="button" class="buttonNum buttonNum">${ftp.count }</button></a>
			       		</c:forEach>
				        <a href="QnAFalseList?pg=${TOPAGE }"><button type="button" class="buttonNum buttonNum">▶</button></a>
				        <a href="QnAFalseList?pg=${ALLPAGE }"><button type="button" class="buttonNum buttonNum">▶▶</button></a>
					</td>
				</tr>
			</table>
		</div>
