	...
	<div class="container_wrap">
		<div class="container">
			...
			<table class="table">
				<tr>
					<td align="center">
				        <a href="QnAFalse.do"><button type="button" class="buttonNum buttonNum">◀◀</button></a>
				        <a href="QnAFalse.do?pg=${FROMPAGE }"><button type="button" class="buttonNum buttonNum">◀</button></a>
			        	<c:forEach items = "${pageCount }" var = "page" varStatus="ftp">
		        		<a href="QnAFalse.do?pg=${ftp.count}"><button type="button" class="buttonNum buttonNum">${ftp.count }</button></a>
			       		</c:forEach>
				        <a href="QnAFalse.do?pg=${TOPAGE }"><button type="button" class="buttonNum buttonNum">▶</button></a>
				        <a href="QnAFalse.do?pg=${ALLPAGE }"><button type="button" class="buttonNum buttonNum">▶▶</button></a>
					</td>
				</tr>
			</table>
		</div>
